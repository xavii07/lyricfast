...
const Galeria = () => {
    ...
    const {strArtistBanner, strArtistClearart, strArtistFanart, strArtistFanart2, strArtistFanart3, strArtistFanart4, strArtistLogo, strArtistThumb, strArtistWideThumb} = info.artists[0]
